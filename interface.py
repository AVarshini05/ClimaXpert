...
def get_visual_crossing_api_key():
    ...
    if not api_key:
        raise ValueError("VISUAL_CROSSING_API_KEY is not set. Add it to your .env file.")
    return api_key
...
with col2:
    ...
    st.image("5.jpg", width=150)  # your image

    st.markdown("""
    <h2>Varshini</h2>
    <p class="dev-role">AI/ML Developer & Cybersecurity Enthusiast</p>
